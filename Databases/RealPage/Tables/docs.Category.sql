...
GO
ALTER TABLE [docs].[Category] ADD CONSTRAINT [PK_Category] PRIMARY KEY CLUSTERED  ([Code]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IXN_Category_RECORDSTAMP] ON [docs].[Category] ([RECORDSTAMP]) ON [PRIMARY]
GO
