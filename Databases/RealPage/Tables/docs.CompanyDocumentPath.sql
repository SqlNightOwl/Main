CREATE TABLE [docs].[CompanyDocumentPath]
(
...
GO
ALTER TABLE [docs].[CompanyDocumentPath] ADD CONSTRAINT [PK_DocumentPath] PRIMARY KEY CLUSTERED  ([CompanyIDSeq]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [IXN_CompanyDocumentPath_RECORDSTAMP] ON [docs].[CompanyDocumentPath] ([RECORDSTAMP]) ON [PRIMARY]
GO
