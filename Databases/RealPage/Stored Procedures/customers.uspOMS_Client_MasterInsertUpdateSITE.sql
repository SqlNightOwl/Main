...
CREATE PROCEDURE [customers].[uspOMS_Client_MasterInsertUpdateSITE] (
  @Code Char(4), 
  @ParentAcctNo Char(4), 
...
--If Not Exists (Select 1 From ACCTDB.dbo.Client_Master Where AcctNo=@Code)
  ...
  Begin -- INSERT SITE INTO Client_Master
--INSERT Into ACCTDB.dbo.Client_Master(
    ...
    Values (
      ...
      'Bill Addr','XXXX','????','XXXX',@ParentAcctNo
    )
  End
  Else
  Begin -- UPDATE SITE in Client_Master --
