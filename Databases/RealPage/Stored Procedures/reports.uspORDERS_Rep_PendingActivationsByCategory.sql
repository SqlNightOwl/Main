...
-- Procedure Name  : uspORDERS_Rep_PendingActivationsByCategory      
...
-- Code Example    : Exec [dbo].[uspORDERS_Rep_PendingActivationsByCategory] 
...
-- 12/13/2010      : Naval Kishore Modified to get QuoteType, Defect # 8532 	      
------------------------------------------------------------------------------------------------------      
CREATE PROCEDURE [reports].[uspORDERS_Rep_PendingActivationsByCategory] (@IPD_StartDate      datetime     = '',
...
BEGIN -->Main BEGIN         
 ...
 ----------------------------------------------------------------------------------
  ...
  group by PRD.PlatformCode,PRD.FamilyCode,PRD.CategoryCode,O.CompanyIDSeq,O.PropertyIDSeq,O.AccountIDSeq,OI.OrderIDSeq,OI.IDSeq,OI.ChargeTypeCode,OI.MeasureCode,OI.FrequencyCode
  order by PlatformName ASC,FamilyName ASC,CategoryName ASC,CompanyName ASC,PropertyName ASC,ProductName ASC,OI.OrderIDSeq ASC
