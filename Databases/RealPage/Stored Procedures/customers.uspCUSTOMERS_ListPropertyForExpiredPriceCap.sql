...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [customers].[uspCUSTOMERS_ListPropertyForExpiredPriceCap]  (
...
BEGIN 
                                         ...
                                         select p.IDseq  as ID, 
                                          ...
                                          and p.IdSeq not in(select  PropertyIDSeq  from Customers.dbo.PriceCapPropertiesHistory with (nolock) 
...
--exec [dbo].[uspCUSTOMERS_ListPropertyForExpiredPriceCap] 'C0910000358', '','','','577'
GO
