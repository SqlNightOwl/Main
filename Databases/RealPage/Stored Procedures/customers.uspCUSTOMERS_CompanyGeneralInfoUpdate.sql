...
-- 2011-07-28      : Mahaboob ( Defect #909 ) --  Modified procedure to Update "ExecutiveIDSeq" in the "Company" table. 
-------------------------------------------------------------------------------------------------------------------------------
CREATE PROCEDURE [customers].[uspCUSTOMERS_CompanyGeneralInfoUpdate] (@IPVC_CompanyIDSeq           varchar(50),   --> CompanyIDSeq identifying the Unique Company record for Update                                                                                               
...
BEGIN
  ...
  select @LDT_SystemDate             = Getdate(),
		 ...
		 @IPVC_ExecutiveCompanyIDSeq = ( case 
  ...
  set     Name						= @IPVC_CompanyName,
          ...
          ExecutiveCompanyIDSeq     = @IPVC_ExecutiveCompanyIDSeq
