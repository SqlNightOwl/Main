...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [quotes].[uspQUOTES_CreateQuoteFromOrdersForSiteTransfertest] (
...
BEGIN
  ...
  begin
    ...
    Insert into QUOTES.dbo.[Group](QuoteIDSeq,DiscAllocationCode,Name,Description,
                                   ...
                                   GroupType,CustomBundleNameEnabledFlag,TransferredFlag)
    Select distinct
    ...
    select distinct 
           ...
           @IPVC_FromPropertyID as PropertyIDSeq,@IPVC_ToCompanyID as CustomerIDSeq,
    ...
    Insert into QUOTES.dbo.QuoteItem(QuoteIDSeq,GroupIDSeq,ProductCode,ChargeTypeCode,FrequencyCode,MeasureCode,
                                     ...
                                     CapMaxUnitsFlag,DollarMinimum,DollarMaximum)
    select distinct 
           @IPVC_QuoteID as QuoteIDSeq,@LI_QuoteGroupID as GroupIDSeq,
           ...
           OI.ChargeAmount,
           (CASE when (OI.ChargeTypeCode = 'ILF' and OI.ActivationEndDate is not null 
           ...
           OI.CapMaxUnitsFlag,OI.DollarMinimum,OI.DollarMaximum
    from  ORDERS.dbo.OrderItem OI with (nolock)
  ...
  select distinct 
           ...
           0 as CapMaxUnitsFlag,C.DollarMinimum,C.DollarMaximum 
    ...
    begin TRY
      BEGIN TRANSACTION; 
        ...
        Insert into DOCUMENTS.dbo.Document(DocumentIDSeq,DocumentTypeCode,DocumentLevelCode,Name,Description,
                                           CompanyIDSeq,QuoteIDSeq,ActiveFlag,CreatedBy,ModifiedBy,CreatedDate,ModifiedDate)
        select  @LVC_DocumentIDSeq as DocumentIDSeq,'FNOT' as DocumentTypeCode, 'PMC' as DocumentLevelCode,
                @LVC_Name as Name,@LVC_Description as Description,@IPVC_ToCompanyID as CompanyIDSeq,
                @IPVC_QuoteID as QuoteIDSeq,1 as ActiveFlag,@IPVC_CreatedBy as CreatedBy,@IPVC_CreatedBy as ModifiedBy,
