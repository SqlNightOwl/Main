...
SET ANSI_NULLS ON
GO
--exec uspQUOTES_GetAllQuotes
--exec uspQUOTES_GetAllQuotes @IPVC_RETURNTYPE = 'XML1'

CREATE PROCEDURE [quotes].[uspQUOTES_GetAllQuotes] (@IPVC_RETURNTYPE  varchar(100) = 'XML')
AS
BEGIN
  set nocount on 
  -----------------------------------------------------------------------------------------------------
