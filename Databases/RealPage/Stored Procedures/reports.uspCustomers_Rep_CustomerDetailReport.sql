...
-- Procedure Name  : [uspCustomers_Rep_CustomerDetailReport]      
-- Description     : This procedure gets Details based on Customer.
-- Input Parameters: All Input Parameters are Optional
-- Code Example    : exec [dbo].[uspCustomers_Rep_CustomerDetailReport]    
...
-- 05/20/2010      : Stored Procedure Created.
...
------------------------------------------------------------------------------------------------------      
CREATE PROCEDURE [reports].[uspCustomers_Rep_CustomerDetailReport]      
(      
...
ORDER BY CustomerName ASC,AccountName ASC	 
