...
GO
/*
exec Orders.dbo.uspORDERS_Orderlistcount                               
                               @IPVC_CustomerName    =   '',
                               @IPVC_City            =   '',
                               @IPVC_State           =   '', 
                               @IPVC_ZipCode         =   '',
...
-- Procedure Name  : uspORDERS_OrderListCount
...
-- Code Example    : exec Orders.dbo.uspORDERS_OrderlistCount 
--                                                  @IPVC_CustomerName    =   '',
--                                                  @IPVC_City            =   '',
--                                                  @IPVC_State           =   '', 
--                                                  @IPVC_ZipCode         =   '',
...
CREATE PROCEDURE [orders].[uspORDERS_OrderListCount] (
...
--EXEC Orders.dbo.uspORDERS_OrderlistCount '', '', '', '', '', 0, '', '', '', '','',''
--EXEC Orders.dbo.uspORDERS_OrderlistCount '', '', '', '', '', 0, '', '', '', '','',''
GO
