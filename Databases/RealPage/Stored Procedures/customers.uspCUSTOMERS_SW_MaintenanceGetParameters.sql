...
CREATE PROCEDURE [customers].[uspCUSTOMERS_SW_MaintenanceGetParameters] (@IPVC_CompanyID varchar(11))
AS
BEGIN 
...
--EXEC [CUSTOMERS].dbo.[uspCUSTOMERS_SW_MaintenanceGetParameters] 'C0802000030'
