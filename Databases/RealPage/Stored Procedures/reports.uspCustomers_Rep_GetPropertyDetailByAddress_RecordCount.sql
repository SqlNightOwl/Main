...
-- Procedure Name  : [uspCustomers_Rep_GetPropertyDetailByAddress_RecordCount]      
-- Description     : This procedure gets Record Count for the report "Customer Detail Report For All Properties"
-- Input Parameters: All Input Parameters are Optional
-- Code Example    : exec [dbo].[uspCustomers_Rep_GetPropertyDetailByAddress_RecordCount]    
...
------------------------------------------------------------------------------------------------------      
CREATE PROCEDURE [reports].[uspCustomers_Rep_GetPropertyDetailByAddress_RecordCount]      
(      
