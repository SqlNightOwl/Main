...
-- Procedure Name  : [uspCustomers_Rep_GetCustomerDetailByInvoiceDeliveryOption_RecordCount]      
-- Description     : This procedure gets the record count for the "CustomerInvoiceDeliveryOption" report.
-- Input Parameters: All Input Parameters are Optional
-- Code Example    : exec [uspCustomers_Rep_GetCustomerDetailByInvoiceDeliveryOption_RecordCount]    
--													@IPVC_CompanyID    = 'C0812000008',
--													@IPVC_CustomerName = '',
--				
-- Revision History:      
-- Author          : Mahaboob Mohammad     
-- 06/13/2011      : Stored Procedure Created. Defect #312
------------------------------------------------------------------------------------------------------      
CREATE PROCEDURE [reports].[uspCustomers_Rep_GetCustomerDetailByInvoiceDeliveryOption_RecordCount]      
(      
