...
-- Procedure Name  : [uspCustomers_Rep_GetCustomerDetailByAddress_RecordCount]      
-- Description     : This procedure gets record count for the report "Customer Detail Report For All PMC"
-- Input Parameters: All Input Parameters are Optional
-- Code Example    : exec [dbo].[uspCustomers_Rep_GetCustomerDetailByAddress_RecordCount]    
--													@IPVC_CompanyID    = 'C0812000008',
--													@IPVC_CustomerName = '',
-- Revision History:      
-- Author          : Mahaboob Mohammad 				
------------------------------------------------------------------------------------------------------      
CREATE PROCEDURE [reports].[uspCustomers_Rep_GetCustomerDetailByAddress_RecordCount]      
(      
