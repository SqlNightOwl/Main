...
-- Procedure Name  : uspORDERS_Rep_GetBillingDetailsByCustomer_RecordCount      
-- Description     : This procedure gets Billing Records Count. 
-- Code Example    : Exec [dbo].[uspORDERS_Rep_GetBillingDetailsByCustomer_RecordCount] '','','','','','','05/05/2009','05/30/2009'
-- Revision History:      
-- Author          : Mahaboob Mohammad     
-- 06/01/2011      : Stored Procedure Created. Defect #314
------------------------------------------------------------------------------------------------------           
CREATE PROCEDURE [reports].[uspORDERS_Rep_GetBillingDetailsByCustomer_RecordCount]      
                                                                  (      
...
BEGIN         
  ...
  set identity_insert #LT_BillingDetailsByCustomer off;   
   ...
   -------------------------------------------------------------------------- 
   -- For Record Count
   SELECT COUNT(1) 'Record Count' from    #LT_BillingDetailsByCustomer S with (nolock)
