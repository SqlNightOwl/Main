...
SET ANSI_NULLS ON
GO
--select ORDERS.DBO.fn_FormatCurrency(-11234.15760,1,2)
--select ORDERS.DBO.fn_FormatCurrency(-1111234.15430,1,2)
CREATE Function [orders].[fn_FormatCurrency] (@IPD_Number decimal(30,10),@IPI_DisplayDecimals Int,@IPI_NumberofDecimalsToDisplay int)
Returns varchar(50)
as
BEGIN  
