create function tcu.fn_DoubleMetaPhone
(	@str varchar(70)	)
returns char(10)
as
/*
...
Created  :	07/31/2006
Purpose  :	Double Metaphone Phonetic Matching Function
			...
			Reduces alphabet to the 14 constonant sounds:
		     "sh"                       "p"or"b" "th"
		      |                             |     |
		      X  S  K  J  T  F  H  L  M  N  P  R  0  W
			by dropping vowels except at the beginning and produces a char(10) string.
			The left(@result,5) gives the most common pronouciation, right(@result,5)
			gives the commonest alternate.
			Translated into T-SQL by Keith Henry (keithh_AT_lbm-solutions.com)
			Based off original C++ code and algorithm by Lawrence Philips
				(lphilips_AT_verity.com)
